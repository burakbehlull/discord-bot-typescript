import { ClientEvents, SlashCommandBuilder, Client as DiscordClient, Message, 
	ChatInputCommandInteraction, Collection } from "discord.js";
...
declare global {
	namespace ITypes {
		...
		export interface IEvent<K extends EventKeys> {
			name: EventKeys;
			once?: boolean;
			execute: (client: IClient, ...args: ClientEvents[K]) => Promise<void> | void;
		}
	}
}
